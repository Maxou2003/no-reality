...
class GroupPostGenerator:
    ...
    def add_post(self, post):
        query = '''
            INSERT INTO group_posts (user_id, instance_id, time_stamp, 
    ...
    def add_comment(self, comment):
        query = '''
            INSERT INTO group_comments (user_id, post_id, comment_text, time_stamp, nb_responses)
            VALUES (%s, %s, %s, %s, %s)'''
        return self.db.execute(query, (
    ...
    def add_reponse(self, reponse):
        query = '''
            INSERT INTO group_responses (comment_id, user_id, response_content, time_stamp)
            VALUES (%s, %s, %s, %s)'''
        return self.db.execute(query, (
    ...
    def add_likes(self, user_id, post_id):
        query = '''
            INSERT INTO group_likes (user_id, post_id)
            VALUES (%s, %s)'''
        return self.db.execute(query, (user_id, post_id))

    def generate_posts(self, post_per_person=30, posts_pathes=None):

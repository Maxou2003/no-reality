...
class SearchController
{
    ...
    public function SearchResults()
    {
        ...
        echo $template->render(['searchContent' => $searchContent, 'posts' => $posts, 'users' => $users, 'groups' => $groups, 'URL' => URL, 'POST_IMG_PATH' => POST_IMG_PATH, 'PROFILE_IMG_PATH' => PROFILE_IMG_PATH]);
    }
